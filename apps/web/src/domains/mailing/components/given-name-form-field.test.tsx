...
import { GivenNameFormField } from "./given-name-form-field";
...
test("<GivenNameFormField /> accesses the form context", function () {
  const jsx = <GivenNameFormField />;
...
test("<GivenNameFormField /> passes the form control to the underlying <FormField /> component", function () {
  const jsx = <GivenNameFormField />;
