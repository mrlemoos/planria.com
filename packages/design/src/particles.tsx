...
export function Particles({
  ...
  function getComputedCircleParams(): Circle {
  ...
  const rgb = transformHexadecimalToRGB(color);
  ...
  function drawParticles() {
    ...
    for (let index = 0; index < particleCount; index++) {
      const circle = getComputedCircleParams();
      drawCircle(circle);
    }
  }
    ...
    circles.current.forEach((circle, index) => {
      ...
      const remapClosestEdge = Number.parseFloat(
        /* self-invoked */ (function (
          ...
          const remapped =
            ((value - leftStart) * (rightEnd - rightStart)) /
              (leftEnd - leftStart) +
            rightStart;
          return remapped > 0 ? remapped : 0;
        })(closestEdge, 0, 20, 0, 1).toFixed(2)
      );
      ...
      if (
        ...
        const newCircle = getComputedCircleParams();
