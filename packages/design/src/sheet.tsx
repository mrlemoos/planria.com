...
export interface SheetProps
  extends ComponentPropsWithoutRef<typeof SheetPrimitive.Root> {}

export const Sheet = SheetPrimitive.Root;

export interface SheetTriggerProps
  extends ComponentPropsWithoutRef<typeof SheetPrimitive.Trigger> {}
...
export interface SheetPortalProps
  extends ComponentPropsWithoutRef<typeof SheetPrimitive.Portal> {}
...
export const sheetVariants = stylesheet.create({
  ...
  <SheetPortal>
    ...
    >
      ...
      <SheetPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary">
        <Icon name="Cross2" size={16} aria-hidden="true" />
